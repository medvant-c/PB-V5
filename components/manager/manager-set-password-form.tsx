...
function ManagerSetPasswordForm({ token }: { token: string | null }) {
      ...
      <Card className="w-full p-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-text-secondary">Для входа в кабинет менеджера</div>
          </div>
        </div>
