...
// Owner-only, same as restore (see [id]/restore/route.ts) — a manager who
// deleted a quote by mistake asks the руководитель to restore it rather
// than browsing the trash themselves. Sorted newest-deleted-first so the
// most recent (most likely to need restoring) is on top.
