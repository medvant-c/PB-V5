...
// Уменьшенная копия для списков/маленьких превью (36–80px) — см.
// lib/desk-services/photo-thumbnail.ts. Тот же доступ, что и у
// /api/manager-quotes/photos/[photoId] (оригинал — для лайтбокса/полного
// просмотра, эта версия — для всего остального).
